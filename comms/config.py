...
USE_TESTNET = os.getenv("USE_TESTNET", "true").lower() == "true"  # Convertir a boolean  export USE_TESTNET=true
SYMBOLS = os.getenv("SYMBOLS", "BTCUSDT,ETHUSDT").split(',')
MODE = os.getenv("BINANCE_MODE", "TESTNET")  # Nuevo: modo de operación   export BINANCE_MODE=LIVE PAPER TESTNET
